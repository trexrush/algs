...
import type { IDataCaseList } from "../../types"
...
const useGrouping = (grouping: "none" | "oll", data: IDataCaseList) => {
  // curry away data and type to make defining sets easier
  const ch = (list: ICaseName[]) => { return listFromData<ICaseName>(list, data) }
